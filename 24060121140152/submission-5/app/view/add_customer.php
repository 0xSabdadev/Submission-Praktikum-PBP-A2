<!-- 
    ...
    Deskripsi: Tampilan untuk menambahkan customer baru 
 -->
<?php
                ...
                <form method="GET" autocomplete="on">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="city" id="city" class="form-control" required>
                            <option value="none" <?php if (!isset($city)) echo 'selected' ?>>--Pilih Kota--</option>
                    ...
                    <button type="button" class="btn btn-primary" onclick="add_customer_post()">POST</button>
                    <button type="button" class="btn btn-primary" onclick="add_customer_get()">GET</button>
