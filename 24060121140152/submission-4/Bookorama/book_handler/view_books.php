...
<div class="card mt-5">
    ...
    <div class="card-body">
        ...
        <a href="../pages/order_data.php" class="btn btn-dark mb-4">Check Order</a>
        ...
        <a href="../pages/logout.php" class="btn btn-danger mb-4 float-right">Logout</a>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn btn-primary btn-sm" href="../pages/show_cart.php?isbn=<?= $row->isbn ?>">+ Cart</a>&nbsp;&nbsp;
