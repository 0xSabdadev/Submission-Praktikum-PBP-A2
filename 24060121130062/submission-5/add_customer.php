<!-- 
File      : add_customer.php		02/10/23
Penulis   : Varrel / 24060121130062
Deskripsi : meampilkan form untuk menambah data customer
-->
<?php
                    ...
                    <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="address" rows="3"
                                name="address"><?php if (isset($address))
                        ...
                        <button type="button" class="btn btn-primary" onclick="add_customer_get()">Add Customer
                            (GET)</button>
                        <button type="button" class="btn btn-secondary" onclick="add_customer_post()">Add Customer
                            (POST)</button>
                    </form>
                    <br>
