<!-- 
File      : add_customer.php		22/09/23
    ...
    <div class="card-body">
        <form method="POST" autocomplete="on" action="">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" name="address" id="address" rows="5"><?php if (isset($address))
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="city" id="city" required>
                    <option value="none" <?php if (!isset($city))
                        echo 'selected="true"'; ?> disabled>--Select a city--
                    </option>
