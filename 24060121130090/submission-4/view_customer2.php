<!--
File      : viw_customer2.php
Deskripsi : untuk menampilkan data customers menggunakan database ditampulkan dengan bootstrapv iew_customer2 pada pemanggilan querynya dirubah untuk tiap label sesuai dengan keinginan masing masing
