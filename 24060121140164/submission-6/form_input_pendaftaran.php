...
<div class="card">
  <?php if (isset($success)): ?>
    ...
    <?php endif; ?>
  <?php endif; ?>
    <section class="bg-black-100 dark:bg-white-900">
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-min lg:py-0">
            ...
            <div class="w-full bg-red rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                <div class="p-6 space-y-2 md:space-y-6 sm:p-8">
                        ...
                        <form class="space-0 md:space-1" name="daftar" method="POST" action="">
                            ...
                            <button type="submit" name="submit" value="submit" class="flex justify-center items-center w-full h-12 shadow bg-blue-500 hover:bg-blue-400 focus:shadow-outline focus:outline-none text-black font-bold rounded"> Daftar Sekarang!
                        </button>
                    </div>
                </div>
        </div>
