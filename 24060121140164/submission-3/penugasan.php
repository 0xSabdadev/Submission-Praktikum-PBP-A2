                ...
                <form id="formDataProduk" method="POST" autocomplete="on" action="">
                    ...
                    <div class="form-check">
                        <label class="form-check-label">
                            ...
                            <?php 
                            if (isset($ekstrakurikuler) && in_array('pramuka', $ekstrakurikuler)) {echo 'checked';}
                            ?>
                            >Pramuka
                        </label>
                        <div class="error">
                            <?php 
                            if (isset($error_ekstrakurikuler)) {echo $error_ekstrakurikuler;}?>
                        </div>
                    </div>
                    <div class="form-check">
                        <label class="form-check-label">
                            <input type="checkbox" class="form-check-input" name="ekstrakurikuler[]" value="seniTari"
                            <?php if (isset($ekstrakurikuler) && in_array('seniTari', $ekstrakurikuler)) {echo 'checked';}?>
                            >Seni Tari
                        </label>
                        <div class="error">
                            <?php
                    ...
                    <div class="form-check">
                        <label class="form-check-label">
                            ...
                            <?php 
                            if (isset($ekstrakurikuler) && in_array('sinematografi', $ekstrakurikuler)) {echo 'checked';}
                            ?>
                            >Sinematografi
                        </label>
