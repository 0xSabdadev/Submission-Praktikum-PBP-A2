                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    <form class="space-y-4 md:space-y-6" action="#" method="POST">
                        ...
                        <div>
                            ...
                            <div class="flex items-center">
                                <input id="coding" type="checkbox" value="coding" name="minat[]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" <?php if(isset($minat) && in_array('coding',$minat)) {echo "checked";} ?>>
                                <label for="coding" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Coding</label>
                            </div>
                            <div class="flex items-center">
                                <input id="uiDesign" type="checkbox" value="uiDesign" name="minat[]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" <?php if(isset($minat) && in_array('uiDesign',$minat)) {echo "checked";} ?>>
                                <label for="uiDesign" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">UI Design</label>
                            </div>
                            <div class="flex items-center">
                                <input id="dataScience" type="checkbox" value="dataScience" name="minat[]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" <?php if(isset($minat) && in_array('dataScience',$minat)) {echo "checked";} ?>>
