...
<!-- NIM: 24060121130091 -->
<!-- Lab: PBP A2 -->
<!-- Deskripsi File: File Penugasan 3 -->
<!-- Tanggal Pembuatan: 17/09/2023 -->
            ...
            <div class="card-body">
                <form method="POST" id="form_input_siswa" autocomplete="on" action="">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nis" name="nis" value="<?php if (isset($_POST['nis']))
                            echo $_POST['nis'] ?>">
                            <div class="error text-danger">
                            <?php if (isset($error_nis))
                            echo $error_nis; ?>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="nama">Nama:</label>
                        <input type="text" class="form-control" id="nama" name="nama" value="<?php if (isset($_POST['nama']))
                            echo $_POST['nama'] ?>">
                            <div class="error text-danger">
                    ...
                    <div class="form-check">
                        <label class="form-check-label">
                            <input type="radio" class="form-check-input" <?php if (isset($_POST['jenis_kelamin']) && $_POST['jenis_kelamin'] == 'pria')
                                echo 'checked' ?> name="jenis_kelamin"
                                    value="pria" />Pria
                            </label>
                            <div class="error text-danger">
                    ...
                    <div class="form-check">
                        <label class="form-check-label">
                            <input type="radio" class="form-check-input" <?php if (isset($_POST['jenis_kelamin']) && $_POST['jenis_kelamin'] == 'Wanita')
                                echo 'checked' ?> name="jenis_kelamin"
                                    value="wanita" />Wanita
                            </label>
                            <div class="error text-danger">
                    ...
                    <div class="form-group">
                        ...
                        <div id="ekskul">
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" <?php if (isset($_POST['ekstrakurikuler']) && in_array('Pramuka', $_POST['ekstrakurikuler']))
                                echo 'checked' ?> name="ekstrakurikuler[]" value="Pramuka" />Pramuka
                                </label>
                                <div class="error text-danger">
                                <?php if (isset($error_ekstrakurikuler))
                                echo $error_ekstrakurikuler; ?>
                            </div>
                        </div>
                        <div class="form-check">
                            <label class="form-check-label">
                                <input type="checkbox" class="form-check-input" <?php if (isset($_POST['ekstrakurikuler']) && in_array('Seni_tari', $_POST['ekstrakurikuler']))
                                    echo 'checked' ?> name="ekstrakurikuler[]"
                                        value="Seni_tari" />Seni Tari
                                </label>
                                <div class="error text-danger">
                                <?php if (isset($error_ekstrakurikuler))
                                    echo $error_ekstrakurikuler; ?>
                        ...
                        <div class="form-check">
                            <label class="form-check-label">
                                <input type="checkbox" class="form-check-input" <?php if (isset($_POST['ekstrakurikuler']) && in_array('Sinematografi', $_POST['ekstrakurikuler']))
                                    echo 'checked' ?> name="ekstrakurikuler[]"
                                        value="Sinematografi" />Sinematografi
                                </label>
                                <div class="error text-danger">
                                <?php if (isset($error_ekstrakurikuler))
                                    echo $error_ekstrakurikuler; ?>
                        ...
                        <div class="form-check">
                            <label class="form-check-label">
                                <input type="checkbox" class="form-check-input" <?php if (isset($_POST['ekstrakurikuler']) && in_array('Basket', $_POST['ekstrakurikuler']))
                                    echo 'checked' ?> name="ekstrakurikuler[]" value="Basket" />Basket
                                </label>
                                <div class="error text-danger">
                                <?php if (isset($error_ekstrakurikuler))
                                    echo $error_ekstrakurikuler; ?>
        ...
        if (isset($_POST["submit"])) {
            ...
            if (!empty($_POST['ekstrakurikuler']) && count($_POST['ekstrakurikuler']) > 0) {
                ...
                foreach ($ekstrakurikuler as $ekstrakurikuler_item) {
                    if (isset($ekstrakurikuler_map[$ekstrakurikuler_item])) {
                        echo '<br />' . $ekstrakurikuler_map[$ekstrakurikuler_item];
                    }
                }
            }
        }
