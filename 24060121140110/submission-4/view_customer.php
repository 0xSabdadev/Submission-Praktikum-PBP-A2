<!-- 
    ...
    NIM         : 24060121140110
    Deskripsi   : Implementasi modul pertemuan 4 (view_customer.php)
-->
        ...
        <div class="card mt-4">
            ...
            <div class="card-body">
                ...
                <table class="table table-striped">
                    ...
                    //inisialisasi session saat ini berdasarkan pengidentifikasi sesi yang diteruskan melalui permintaan GET atau POST
                    session_start();
                    //memanggil halaman
