                ...
                <form class="space-y-4 md:space-y-6" name="daftar" action="" method="POST">
                    ...
                    <div>
                        ...
                        <div class="flex items-center mb-1">
                            <input id="jenis-kelamin-1" type="radio" value="laki-laki" name="jenis-kelamin" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="jenis-kelamin-1" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Laki-laki</label>
                        </div>
                        <div class="flex items-center mb-1">
                            <input id="jenis-kelamin-2" type="radio" value="perempuan" name="jenis-kelamin" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="jenis-kelamin-2" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Perempuan</label>
                        </div>
