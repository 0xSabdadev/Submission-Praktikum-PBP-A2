...
// Deskripsi    : menampilkan data customer dari database
-->
    ...
    <div class="card-body">
        ...
        <table class="table table-striped">
            ...
            while ($row = $result->fetch_object()) {
                ...
                echo '<td>' . $row->city . '</td>';
                echo '<td><a class="btn btn-warning btn-sm" href="edit_customer.php?id=' . $row->customerid . '">
                Edit</a>&nbsp;&nbsp;
                <a class="btn btn-danger btn-sm" href="confirm_delet_customer.php?id=' . $row->customerid . '">
                Delete</a>
                    </td>';
                echo '</tr>';
                $i++;
