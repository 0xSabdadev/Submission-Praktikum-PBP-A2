        ...
        <div class="card-body">
            ...
            <form method="POST" id="form_input_siswa" autocomplete="on" action="">
                ...
                <div class="form-check">
                    <label class="form-check-label">
                        <input type="radio" class="form-check-input" name="jenis_kelamin" value="pria"
                            <?php if (isset($jenis_kelamin) && $jenis_kelamin == "pria") {
                                                                                                            echo 'checked';
                                                                                                        } ?>>Pria</label>
                </div>
                <div class="form-check">
                    <label class="form-check-label">
                        <input type="radio" class="form-check-input" name="jenis_kelamin" value="wanita"
                            <?php if (isset($jenis_kelamin) && $jenis_kelamin == "wanita") {
                                                                                                                echo 'checked';
                                                                                                            } ?>>Wanita</label>
                ...
                <div id="ekstrakulikuler">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="ekskul[]" value="pramuka"
                            <?php if (isset($ekskul) && in_array('pramuka', $ekskul)) echo 'checked'; ?>>
                        <label class="form-check-label" for="flexCheckDefault">Pramuka</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="ekskul[]" value="seni tari"
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="ekskul[]" value="sinematografi"
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="ekskul[]" value="basket"
            ...
            <?php
            // Tampilkan "Your Input" di bawah tombol submit dan reset jika tidak ada kesalahan validasi
