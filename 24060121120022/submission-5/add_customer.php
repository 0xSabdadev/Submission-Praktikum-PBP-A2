<!--
    ...
    NIM             : 24060121120022
    Lab             : A2 PBP
    Deskripsi       : Implementasi add_customer.php pada modul praktikum 5
-->
            ...
            <div class="card-body">
                <form method="GET" autocomplete="on">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="name" name="name" value="<?php if (isset($name)) echo $name ?>" autocomplete="on">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="address" rows="3" name="address" autocomplete="on"><?php if (isset($address)) echo $address ?></textarea>
                        <div class="text-danger small">
