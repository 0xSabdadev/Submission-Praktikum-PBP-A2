<!-- 
    ...
    Deskripsi Kode  : File yang me-request get_customer_post.php dengan menggunakan fungsi show_customer_post(this.value) 
-->
    ...
    <div class="col">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <br>
                <div id="detail_customer" class="alert alert-success"></div>
            </div>
        </div>
    </div>
</div>
