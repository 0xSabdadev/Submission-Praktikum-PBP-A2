                ...
                <form method="GET" autocomplete="on">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="city" id="city" class="form-control" required>
                            <option value="" <?php if (!isset($city)) echo 'selected' ?>>--Select a city--</option>
                    ...
                    <div>
                    <button type="button" class="btn btn-primary" onclick="add_customer_get()">Add Customer (GET)</button></br>
                    </div>
